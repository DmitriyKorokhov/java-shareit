...
public interface BookingService {
    ...
    Collection<BookingResponseDto> getAllBookings(BookingState state, int userId);

    Collection<BookingResponseDto> getAllBookingForOwner(BookingState state, int ownerId);
}
